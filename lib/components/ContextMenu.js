...
var ContextMenu = function (_Component) {
  ...
  function ContextMenu() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ContextMenu.__proto__ || Object.getPrototypeOf(ContextMenu)).call.apply(_ref, [this].concat(args))), _this), _this.windowEventsBound = false, _this.state = {
      x: 0,
      y: 0,
      visible: false,
      nativeEvent: null
    }, _this.menu = null, _this.refsFromProvider = null, _this.unsub = [], _this.hideTimeout = null, _this.bindWindowEvent = function () {
      if (!_this.windowEventsBound) {
